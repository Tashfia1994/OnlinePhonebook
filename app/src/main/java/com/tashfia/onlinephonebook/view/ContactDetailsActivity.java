package com.tashfia.onlinephonebook.view;
...
import com.tashfia.onlinephonebook.Constant;
import com.tashfia.onlinephonebook.HomeActivity;
import com.tashfia.onlinephonebook.R;
...
public class ContactDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(ContactDetailsActivity.this, "Please edit data!", Toast.LENGTH_SHORT).show();
                }
    ...
    public void UpdateContact() {
        ...
        if (name.isEmpty()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("success")) {
                                ...
                                Toast.makeText(ContactDetailsActivity.this, " Successfully Updated!", Toast.LENGTH_SHORT).show();
                            ...
                            //If we are getting success from server
                                ...
                                Intent intent = new Intent(ContactDetailsActivity.this, HomeActivity.class);
                                Toast.makeText(ContactDetailsActivity.this, " Update fail!", Toast.LENGTH_SHORT).show();
                                //startActivity(intent);

                            } else {

                                loading.dismiss();
                                Toast.makeText(ContactDetailsActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(ContactDetailsActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_LONG).show();
                            loading.dismiss();
                        }
                    }) {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(ContactDetailsActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("success")) {
                            ...
                            Intent intent = new Intent(ContactDetailsActivity.this, HomeActivity.class);
                            Toast.makeText(ContactDetailsActivity.this, " Successfully Deleted!", Toast.LENGTH_SHORT).show();
                            startActivity(intent);
                        ...
                        //If we are getting success from server
                            ...
                            Intent intent = new Intent(ContactDetailsActivity.this, HomeActivity.class);
                            Toast.makeText(ContactDetailsActivity.this, " Delete fail!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);
